...
\item[Nagłówek Set-Cookie] \hfill \\
	...
	\item[Max-Age] \hfill \\
	Podobnie jak \emph{Expires} określa maksymalny czas życia ciasteczka, ale definiowany jest jako liczba sekund. Jeśli obydwa atrybuty (\emph{Expires} i \emph{Max-Age}) występują w jednej odpowiedzi \emph{HTTP}, priorytet ma \emph{Max-Age}.
	\item[Domain] \hfill \\
